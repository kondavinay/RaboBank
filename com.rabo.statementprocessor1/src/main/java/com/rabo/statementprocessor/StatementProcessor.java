...
public class StatementProcessor {
	...
	public void csvAndXmlFileReading() throws ClassNotFoundException {
		...
		try {
			FailedRecordReferences.duplicates(RecordReferenceValidation.validationMethod(file.process()));
			InvalidEndBalances.duplicates2(EndBalanceValidation.details(RecordReferenceValidation.validRecords));
		} catch (IOException e) {
